...
# Genotype file name
SNP_file_name = ("~/Downloads/data/combined.vcf.samples.matrix2.NAfilter");
snps_location_file_name = ("~/Downloads/data/combined.vcf.samples.matrix2.NAfilter.meqtl_pos");

# Gene expression file name
expression_file_name = ("~/Downloads/data/GD462.GeneQuantRPKM.50FN.samplename.resk10.txt.samples");
gene_location_file_name = paste("~/Downloads/data/gene_loc");
...
output_file_name_cis = "~/Downloads/results/onlyCISresults.txt"
output_file_name_tra = "~/Downloads/results/onlyTRANSresults.txt"
