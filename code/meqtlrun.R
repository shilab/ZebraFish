...
me1<-mxeqtl('data/CNV_matrix.newID.out.filter','data/CNV_position','data/kidney_expression.out','data/gene_position','CNV_kidney_CISResults',0.05,covariates='data/CNV_kid_cov',qq='kidney_CNV-qq.pdf')

me2<-mxeqtl('data/CNV_matrix.newID.out.filter','data/CNV_position','data/liver_expression.out','data/gene_position','CNV_liver_CISResults',0.05,covariates='data/CNV_liv_cov',qq='liver_CNV-qq.pdf')

me3<-mxeqtl('data/CNV_matrix.newID.miR_expr_out.filter','data/CNV_position','data/kidney_miRNA_expression.miR_expr_out.newID','miRNA_positions.gene','CNV-kidney-miR-CISResults',0.05,covariates='data/CNV_kid-miR_cov',qq='CNV_kid-miR-qq.pdf')

me4<-mxeqtl('data/CNV_matrix.newID.miR_expr_out.filter','data/CNV_position','data/liver_miRNA_expression.miR_expr_out.newID','miRNA_positions.gene','CNV-liver-miR-CISResults',0.05,covariates='data/CNV_liv-miR_cov',qq='CNV_liv-miR-qq.pdf')

me5<-mxeqtl('data/kidney_miRNA_expression.miR_out.newID','miRNA_positions.snps','data/kidney_expression.miR_out','data/gene_position','kidney-miR-expr-CISResults',0.05,covariates='data/kid-miR-expr_cov',qq='kid-miR-expr-qq.pdf')

me6<-mxeqtl('data/liver_miRNA_expression.miR_out.newID','miRNA_positions.snps','data/liver_expression.miR_out','data/gene_position','liver-miR-expr-CISResults',0.05,covariates='data/liv-miR-expr_cov',qq='liv-miR-expr-qq.pdf')
